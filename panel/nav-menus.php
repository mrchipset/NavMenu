            ...
            <div class="row typecho-page-main typecho-post-area">
                <div id="edit-secondary" class="col-mb-12 col-tb-4" role="complementary">
                    ...
                    <div class="typecho-table-wrap" id="menu-list">
                        ...
                        <ul id="menu-item-cat" class="typecho-option-tabs clearfix">
                            ...
                            <li class="col-mb-6 col-wd-3"><a href="#page" id="tab-files-btn"><?php _e('独立页面') ?></a>
                            </li>
                            <li class="col-mb-6 col-wd-3"><a href="#internal" id="tab-files-btn"><?php _e('内置链接') ?></a>
                            </li>
                            <li class="col-mb-6 col-wd-3"><a href="#custom" id="tab-files-btn"><?php _e('自定义') ?></a>
                            </li>
                        </ul>
                            ...
                            <section class="typecho-post-option category-option">
                                ...
                                <ul>
                                    <?php while ($category->next()) : ?>
                                        <li><?php echo str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;', $category->levels); ?>
                                            <input type="checkbox" name="cat" id="category-<?php $category->mid(); ?>"
                        ...
                        <div id="internal" class="tab-content hidden">
                            <section class="typecho-post-option category-option">
                                <ul>
                                    <li><input type="checkbox" name="index" id="index" value="{siteUrl}"
                                               data-type="custom" data-name="<?php _e("首页"); ?>" data-url="{siteUrl}"/>
                                        <label for="index"><?php _e("首页"); ?></label>
                                    </li>
                                    <li><input type="checkbox" name="admin" id="admin" value="{adminUrl}"
                                               data-type="custom" data-name="<?php _e("后台"); ?>" data-url="{adminUrl}"/>
                ...
                <div class="col-mb-12 col-tb-8" role="main">
                    <div class="col-mb-12 typecho-list">
                        <div class="typecho-table-wrap" style="padding-bottom: 0;overflow: hidden;">
                            <p style="height: 30px;display: flex;align-items: center;">有什么使用问题欢迎<a target="_blank"
                                                                                                   href="https://qm.qq.com/cgi-bin/qm/qr?k=ByRkaTuBSLR5qyuvDFAUblX2t0S1q_ls&amp;jump_from=webapi"
                                                                                                   rel="noopener noreferrer"
                                                                                                   style="padding-left: 10px;"><img
                                        src="//pub.idqqimg.com/wpa/images/group.png" alt="32MB Club" title="32MB Club"
                                        border="0"></a></p>
                        </div>
